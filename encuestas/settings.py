...
SECRET_KEY = 'django-insecure-c0h4(dvf4u9j61750_lr&l2+q+2oj^qrf)@t0)x#xwd+=gbmm%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'testserver']  # Add localhost y 127.0.0.1 for development
...
INSTALLED_APPS = [
    'polls',
    'core',  # Clean Architecture domain and use cases
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'encuestas', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'encuestas_db.sqlite3',
    }
}
...
LOGIN_REDIRECT_URL = '/polls/admin-dashboard/'
LOGOUT_REDIRECT_URL = '/'
